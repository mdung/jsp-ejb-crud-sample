 ...
 * UPDATED: Added phoneNumber field support
 */
public class EmployeeDAO {
    ...
    /**
     * Create new employee
     * UPDATED: Includes phoneNumber in INSERT
     */
    ...
    /**
     * Find employee by ID
     * UPDATED: Includes phoneNumber in SELECT
     */
    ...
    public List<Employee> findAll() throws SQLException, NamingException {
        String sql = "SELECT id, name, email, department, phone_number FROM employees ORDER BY id";
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    /**
     * Update employee
     * UPDATED: Includes phoneNumber in UPDATE
     */
     ...
     * UPDATED: Maps phoneNumber field
     */
